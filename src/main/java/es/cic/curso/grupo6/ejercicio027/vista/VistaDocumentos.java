...
public class VistaDocumentos extends VerticalLayout implements View {
	...
	public VistaDocumentos() {
		...
		// layout. FICHEROS
		VerticalLayout layoutFicheros = inicializaLayoutFicheros();
	...
	private VerticalLayout inicializaLayoutFicheros() {
		...
		layoutFicheros.setMargin(true);
		layoutFicheros.setSpacing(true);
		layoutFicheros.setSizeFull();
		layoutFicheros.addComponents(gridFicheros, layoutBotonesFicheros, formulario);
